...
import MyProduct from './pages/MyProduct';//new..
const SellerDashboard = () => {
    ...
    return (
        <>
            <Box sx={{ display: 'flex' }}>
                <CssBaseline />
                <AppBar open={open} position='absolute' sx={{ backgroundColor: "#154406" }}>
                    <Toolbar sx={{ pr: '24px' }}>
                        <IconButton
                            edge="start"
                            color="inherit"
                ...
                <Box component="main" sx={styles.boxStyled}>
                    ...
                    <Route path="/" element={<SellerHomePage />} />
                        ...
                        <Route path="/Seller/orders/addproducts" element={<AddProduct />} />
                        <Route path="/Seller/orders/customers/:id" element={<ShowCustomers />} />
                        <Route path="/Seller/orders/product/:id" element={<MyProduct />} />
