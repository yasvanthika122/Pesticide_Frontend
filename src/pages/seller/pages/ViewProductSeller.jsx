...
const ViewProductSeller = () => {
  ...
  const [expirationDate, setExpirationDate] = useState(""); // Added expirationDate state
  ...
  useEffect(() => {
    if (productDetails) {
      ...
      setExpirationDate(productDetails.expirationDate || ""); // Set expirationDate from productDetails
    }
  ...
  const fields = {
    ...
    tagline,
    stock,
    expirationDate, // Include expirationDate in fields
  };
                ...
                <ProductContainer>
                  ...
                  <ProductInfo>
                    ...
                    <ProductDetails>
                     ...
                     {/*  <p>Expiration Date: {productDetails && productDetails.expirationDate}</p>  */}
                    </ProductDetails>
                  </ProductInfo>
                </ProductContainer>
