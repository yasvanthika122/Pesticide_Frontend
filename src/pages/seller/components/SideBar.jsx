    ...
    return (
        <>
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <WidgetsIcon sx={{ color: (location.pathname === "/" || location.pathname === "/Seller/dashboard") ? '#154406' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <ShoppingCartIcon sx={{ color: location.pathname.startsWith('/Seller/products') ? '' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <PendingActionsIcon sx={{ color: location.pathname.startsWith("/Seller/orders") ? '#154406' : 'inherit' }} />
                    </ListItemIcon>
                ...
                </ListItemButton>
                {
                    ...
                    >
                        <ListItemIcon>
                            <AdminPanelSettingsIcon sx={{ color: location.pathname.startsWith("/Seller/shopcart") ? '#154406' : 'inherit' }} />
                        </ListItemIcon>
            ...
            <React.Fragment>
                ...
                >
                    <ListItemIcon>
                        <AccountCircleIcon sx={{ color: location.pathname.startsWith("/Seller/profile") ? '#154406' : 'inherit' }} />
                    </ListItemIcon>
                ...
                >
                    <ListItemIcon>
                        <LogoutIcon sx={{ color: location.pathname.startsWith("/logout") ? '#154406' : 'inherit' }} />
                    </ListItemIcon>
