                            ...
                            <>
                                <ProductContainer>
                                    ...
                                    <ProductInfo>
                                        ...
                                        <Description><paragraph>{productDetails && productDetails.description}</paragraph></Description>
                                        <ProductDetails>
                                            <p><CategoryText>Category:</CategoryText> {productDetails && productDetails.category}</p>
                                            <p><TechnicalContentText>Technical Content:</TechnicalContentText> {productDetails && productDetails.subcategory}</p>
                                        </ProductDetails>
                                    </ProductInfo>
                                </ProductContainer>
