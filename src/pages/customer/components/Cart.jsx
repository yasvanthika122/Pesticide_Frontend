...
import { addToCart, removeAllFromCart, removeFromCart, decreaseStock } from '../../../redux/userSlice'; // Import decreaseStock
...
const Cart = ({ setIsCartOpen }) => {
    ...
    const handleAddToCart = (product) => {
        if (product.quantity < product.stock) {
            ...
            dispatch(decreaseStock(product)); // Dispatch action to decrease stock
        } else {
