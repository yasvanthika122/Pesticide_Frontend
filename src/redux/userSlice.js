...
const userSlice = createSlice({
    ...
    reducers: {
        ...
        setTotalCustomersforlogin: (state, action) => {
            state.totalCustomersforlogin = action.payload;
        },

        decreaseStock: (state, action) => {
            const { _id } = action.payload;
            const productToUpdate = state.currentUser.cartDetails.find(cartItem => cartItem._id === _id);
